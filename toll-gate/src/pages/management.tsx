...
const ManagementPage = () => {
  ...
  const handleExportLogs = () => {
    const fakeLogs = [
      { timestamp: '2026-04-14 08:30:12', uid: 'RFID-4521', action: 'ENTRY', status: 'SUCCESS' },
      { timestamp: '2026-04-14 09:15:45', uid: 'RFID-7832', action: 'ENTRY', status: 'SUCCESS' },
      { timestamp: '2026-04-14 10:05:22', uid: 'RFID-1234', action: 'ENTRY', status: 'REJECTED' },
    ];
      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.sectionCard}>
          ...
          <div className={styles.exportButtons}>
            <button onClick={handleExportCards} className={`${styles.exportBtn} ${styles.btnCyan}`}>
              <Download size={18} />
              <span>Export Cards (CSV)</span>
            </button>
            <button onClick={handleExportLogs} className={`${styles.exportBtn} ${styles.btnGreen}`}>
              <FileText size={18} />
        ...
        <div className={styles.sectionCard}>
          <div className={styles.registryHeader}>
            <h2 className={styles.sectionTitle} style={{ marginBottom: 0 }}>RFID CARD REGISTRY</h2>
        ...
        {isModalOpen && (
          <div style={{
            ...
            <div style={{
              ...
              border: '1px solid #1e293b', width: '400px'
            }}>
              ...
              <form onSubmit={handleAddCard} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <button type="submit" className={styles.addBtn} style={{ width: '100%', justifyContent: 'center', marginTop: '1rem', padding: '1rem' }}>
                  Save Card
                </button>
              </form>
            </div>
